...
if [[ "$acc" == "y" ]]; then
	linode-cli tickets create --description 'Hello! I have recently installed the axiom framework http://github.com/pry0cc/axiom and would like to request an image increase to 18GB please for the purposes of running packer. Thank you have a great day! - This request was automatically generated by Axiom' --summary 'Image increase request to 18GB for Axiom' --region ''
